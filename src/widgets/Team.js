    ...
    return (
        <li ref={ref} className={`rounded overflow-hidden flex flex-col md:flex-row transition-opacity ease-in duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="w-full flex flex-col items-center justify-center">
                ...
                <a target="_blank" rel="noreferrer" href={websiteLink}><button className="mb-12 transition duration-100 ease-in hover:bg-purple active:bg-darkPurple md:mb-20 border border-cream rounded-full px-4 py-2 w-fit"><p className="text-white">Visit their Website</p></button></a>
            </div>
        </li>
    );
}
